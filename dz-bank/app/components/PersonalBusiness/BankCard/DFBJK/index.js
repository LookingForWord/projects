...
const DFBJK = ({data}) => {
    return (
        <div className="bank-card-dfbjk">
            <div className="template-body-banner">
                <img src={data.bannerUrl || require('../../../../static/images/personal_banner_bank.jpg')} title={data.title || '丹凤白金卡'}/>
            </div>
            <div className="template-body-content overflow-top">
                <h2>{data.title || '丹凤白金卡'}</h2>
                <div className="bank-card-dfbjk-main">
                    data.content ?
                    (
                    <div className="bank-card-dfbjk-dynamic"
                         dangerouslySetInnerHTML={ {__html: data.content}}/>
                    ) :
                    (
                    <div className="bank-card-dfbjk-static">
                        <h6>卡面展示</h6>
                        <img src={require('./images/dfbjk.png')} alt="丹凤白金卡"/>
                        <h6>申领条件</h6>
