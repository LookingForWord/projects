...
const ServiceSite = ({data}) => {
    ...
    return (
        <div className="service-site-container">
            <h2><Link to="/">首页</Link><em>/</em><span>服务网点</span></h2>
            <div className="service-site-main">
                <h4>{data.title || '营业网点服务信息 '}</h4>
                            ...
                            :(
                                <div className="service-site-static">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th style={{width:'30%'}}>网点名称</th>
                                                <th style={{width:'40%'}}>地址</th>
                                                <th style={{width:'20%'}}>服务电话</th>
