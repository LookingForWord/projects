<template>
  <el-card class="box-card refund-all-card" v-loading.body="loading">
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      if (this.$constant.REFUNDALL) {
        let me = this;
        this.loading = true;
        this.total = 0;
        this.pageUrl = this.$constant.REFUNDALL;
        this.$http({
          url: this.$constant.REFUNDALL,
          vm: me,
          method: "GET",
